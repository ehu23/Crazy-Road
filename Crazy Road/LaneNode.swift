...
class LaneNode: SCNNode {
    ...
    func getVehicle(for type: Int) -> SCNNode {
        ...
        default: //shouldnt be called ever but needed since Ints are the switch case and we didnt exhaust the options, xcode can detect this and won't allow no default.
            return Models.car.clone()
        }
    }
    required init?(coder aDecoder: NSCoder) {
